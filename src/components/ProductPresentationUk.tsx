...
const ProductPresentationUk = () => {
  ...
  const benefits = [
    "30 carefully selected prayers",
    "Authentic words from Pope Francis",
    "Guide to strengthen your daily faith",
    "Moments of peace and reflection",
    "PDF format to read anywhere",
      ...
      <div className="container mx-auto px-4 sm:px-6 max-w-7xl">
        <div className="text-center mb-12 sm:mb-16 animate-fade-in">
          <h2 className="font-playfair text-2xl sm:text-3xl md:text-4xl font-bold text-gray-800 mb-4 break-words">
            ...
            <span className="block text-spiritual-gold">of Pope Francis's Prayers</span>
          </h2>
          <p className="text-lg sm:text-xl text-gray-600 max-w-3xl mx-auto">
            A spiritual treasure that will accompany you in every moment of prayer and reflection
          </p>
        </div>
        ...
        <div className="flex flex-col lg:flex-row items-center gap-8 lg:gap-12">
          ...
          <div className="flex-1 flex justify-center animate-scale-in w-full">
            <div className="relative max-w-xs sm:max-w-sm lg:max-w-md">
              <div className="absolute -inset-4 sm:-inset-6 bg-gradient-to-r from-spiritual-gold/20 to-spiritual-lightGold/20 rounded-3xl blur-2xl"></div>              <img 
                src="/lovable-uploads/mockupuk.webp" 
                alt="eBook 30 Prayers by Pope Francis"
          ...
          <div className="flex-1 space-y-6 lg:space-y-8 animate-fade-in w-full">
            <div className="space-y-4 lg:space-y-6">
              <div className="flex items-center justify-center lg:justify-start gap-3 text-spiritual-gold">
                ...
                <span className="font-semibold text-sm sm:text-base">Digital eBook in PDF</span>
              </div>
              ...
              <div className="bg-spiritual-warm/30 p-4 sm:p-6 rounded-2xl max-w-md mx-auto lg:max-w-none">
                <div className="flex items-center gap-3 mb-3 justify-center lg:justify-start">
                  ...
                  <span className="font-semibold text-gray-800 text-sm sm:text-base">Who is this eBook for:</span>
                </div>
                <p className="text-sm sm:text-base text-gray-700 text-center lg:text-left">
                  Christians who seek to strengthen their faith, create a meaningful devotional routine 
                  and find peace through Pope Francis's inspiring words.
                </p>
              </div>
...
export default ProductPresentationUk;
