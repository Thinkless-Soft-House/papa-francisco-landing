          ...
          <div className="flex-1 text-center lg:text-left space-y-6 lg:space-y-8 animate-fade-in max-w-2xl lg:max-w-none">
            <div className="space-y-4">
              <div className="flex items-center justify-center lg:justify-start gap-2 text-spiritual-gold">
                ...
                <span className="text-xs sm:text-sm font-medium tracking-wide uppercase">Palavras que tocam a alma</span>
              </div>
            ...
            <div className="space-y-4 lg:space-y-6">
              ...
              >
                <span className="hidden sm:inline">QUERO FORTALECER MINHA FÉ AGORA</span>
                <span className="sm:hidden">FORTALECER MINHA FÉ</span>
